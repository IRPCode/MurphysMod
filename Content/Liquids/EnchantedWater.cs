...
{
    public class EnchantedWater : ModLiquid
    { //Textures are kept inside of the liquids folder for the sake simplicity, as Tmodloader and LiquidLib handles this automatically 
        ...
        public override void SetStaticDefaults()
        {
            ...
            FishingPoolSizeMultiplier = 0f;

            AddMapEntry(new Color(11, 76, 129), CreateMapEntryName()); //change the color too
        }
        ...
        {
            return ModContent.GetInstance<EnchantedWaterFall>().Slot;
        }
        ...
        public override bool OnProjectileSplash(Projectile proj, bool isEnter)
        {
            ...
            SoundEngine.PlaySound(SoundID.Item9, proj.position);
            return false;
        }
        ...
        public override bool OnItemSplash(Item item, bool isEnter)
		{
            ...
            SoundEngine.PlaySound(SoundID.Item9, item.position);
			return false;
		}
