...
{
    public class AccursedSap : ModLiquid
    { //Textures are kept inside of the liquids folder for the sake simplicity, as Tmodloader and LiquidLib handles this automatically 
        public static readonly SoundStyle sound = new("MurphysMod/Assets/Audio/AccursedSapSplash")
        {
            Volume = 1f,
            Pitch = 0f,
            PitchVariance = .2f
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(60, 64, 39), CreateMapEntryName());
        }
        ...
        {
            return ModContent.GetInstance<AccursedSapFall>().Slot;
        }
        ...
        {
            drawData.liquidAlphaMultiplier *= 2f;
