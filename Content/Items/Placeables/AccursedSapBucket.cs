...
{
	public class AccursedSapBucket : ModItem
	{
		public override String Texture => "MurphysMod/Assets/Textures/Items/AccursedSapBucket";
		...
		public override void SetStaticDefaults()
		{
			...
			LiquidID_TLmod.Sets.CreateLiquidBucketItem[LiquidLoader.LiquidType<BlessedWater>()] = Type;
		...
		public override void HoldItem(Player player)
		{
			if (!player.JustDroppedAnItem)
			{
				...
				{
					if (tile.LiquidType != LiquidLoader.LiquidType<BlessedWater>())
					{
						return;
					}
				}
				...
				tile.LiquidType = LiquidLoader.LiquidType<AccursedSap>();
