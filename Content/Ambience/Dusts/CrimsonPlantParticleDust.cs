...
namespace MurphysMod.Content.Ambience.Dusts
{
    ...
    public class CrimsonPlantParticleDust : ModDust
    {
        public override string Texture => "MurphysMod/Assets/Textures/Dusts/CrimsonPlantParticleDust"; 
