...
namespace MurphysMod.Content.Ambience.Dusts
{
    ...
    public class AccursedSapDust : ModDust
    {
        public override string Texture => "MurphysMod/Assets/Textures/Dusts/AccursedSapDust";

        public override void OnSpawn(Dust dust)
        {
            dust.velocity = new Vector2(Main.rand.Next(-10, 10) / 15, Main.rand.Next(2, 8) / 5);
