...
{
    public class Hailstone : ModProjectile
    {
        public bool hitGround = false;
        public override string Texture => "MurphysMod/Assets/Textures/Projectiles/Hailstone";
        ...
        public override bool CanHitPlayer(Player player)
        {
            ...
            if(player.HeldItem.type == ItemID.Umbrella || player.HeldItem.type == ItemID.TragicUmbrella || helmet.type == ItemID.UmbrellaHat) //no damage when using any umbrella
            {
                return false;
            } else
            return true;
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            if (!hitGround)
            {
                SoundEngine.PlaySound(SoundID.Dig, Projectile.Center); //fix this to find the real sound needed for arrows hitting the ground
